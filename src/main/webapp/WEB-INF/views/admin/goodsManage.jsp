	                    	...
	                    	<table class="goods_table">
	                    		<thead>
	                    			<tr>
	                    				...
	                    				<td class="th_column_5">재     고</td>
	                    				<td class="th_column_6">등록날짜</td>
	                    			</tr>
	                    		</thead>	
	                    		<c:forEach items="${list}" var="list">
	                    		<tr>
	                    			<td><c:out value="${list.imageId}"></c:out></td>
	                    			<td>
	                    				<a class="move" href='<c:out value="${list.imageId}"/>'>
											<c:out value="${list.imageName}"></c:out>
										</a>	                    				
	                    			</td>
	                    			<td><c:out value="${list.authorName}"></c:out></td>
	                    			<td><c:out value="${list.catName}"></c:out></td>
	                    			<td><c:out value="${list.imageStock}"></c:out></td>
                	...
                	<div class="search_wrap">
                		<form id="searchForm" action="/admin/goodsManage" method="get">
                			<div class="search_input">
                    			...
                    			<input type="hidden" name="pageNum" value='<c:out value="${pageMaker.criteria.pageNum }"></c:out>'>
...
$(".move").on("click", function(e){
	...
	moveForm.append("<input type='hidden' name='imageId' value='"+$(this).attr("href") + "'>");
